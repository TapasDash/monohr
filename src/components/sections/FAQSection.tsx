  ...
  return (
    <section className="px-4 pb-18 lg:px-[75px] lg:pb-24">
      <div className="mx-auto grid w-full max-w-[1440px] grid-cols-1 gap-10 lg:grid-cols-[0.92fr_1.28fr] lg:gap-14">
        <div>
          <h2 className="text-foreground text-[36px] leading-[130%] font-[450] tracking-[-0.05%] lg:max-w-[395px] lg:text-[48px]">
              ...
              >
                <div className="flex items-center justify-between gap-4">
                  ...
                  >
                    <Plus
                      size={20}
                      className={`text-[#1C1C1E] transition-all duration-300 ${isOpen ? 'rotate-45' : 'rotate-0'}`}
                    />
                  </button>
                </div>
