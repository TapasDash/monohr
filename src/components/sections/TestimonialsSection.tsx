...
export function TestimonialsSection() {
  ...
  const visibleProfiles = [
    ...
    },
    {
      index: activeIndex,
      positionClass:
        'h-18 w-18 scale-110 shadow-[0_8px_24px_rgba(15,23,42,0.2)]',
    },
    {
      index: getWrappedIndex(activeIndex + 1),
      positionClass:
  ...
  return (
    <section
      className="px-4 py-18 lg:px-11.75 lg:py-24"
      aria-labelledby="testimonials-heading"
    >
      <div className="mx-auto flex w-full max-w-260 flex-col items-center text-center">
        <span className="text-foreground inline-flex rounded-full border border-[#EAEAE2] bg-white px-3.5 py-1.5 align-middle text-[16px] leading-6 tracking-[-0.56px]">
            ...
            return (
              ...
              >
                <Image
                  ...
                  fill
                  className={`rounded-full object-cover object-top ${isActive ? 'h-[75px] w-[75px]' : 'h-[60px] w-[60px]'}`}
                />
              </button>
            );
          })}
        ...
        <blockquote className="mt-28 max-w-[1120px] text-center text-[36px] leading-[130%] tracking-[-0.05%] text-[#191919] lg:text-[48px]">
