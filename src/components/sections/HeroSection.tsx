    ...
    return (
        ...
        >
            <div className="mx-auto flex w-full max-w-230 flex-col items-center text-center">
                <div className="mb-8 inline-flex flex-wrap items-center justify-center overflow-hidden rounded-full border border-border bg-background/50 backdrop-blur-md shadow-sm lg:mb-10 divide-x divide-border">
                ...
                <p className="mt-6 max-w-[427px] text-[14px] leading-[1.15] tracking-[-0.01em] text-foreground/50 sm:text-[16px] lg:mt-7 lg:text-[20px]">
                ...
                <button
                    type="button"
                    className="mt-8 inline-flex items-center gap-3 rounded-full bg-foreground px-[25px] py-[15px] text-[18px] font-medium leading-none text-white transition-all hover:scale-105 active:scale-95 lg:mt-9"
                >
                    Deploy a Team
