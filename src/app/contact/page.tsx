export default function ContactPage() {
  return (
    <section className="mt-20 px-2 py-16 lg:px-40 lg:py-20">
      <div className="mx-auto w-full max-w-280">
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-[1fr_1fr] lg:gap-14">
          <div className="space-y-8 px-4 lg:px-0">
            <h1 className="text-foreground text-[32px] leading-[120%] tracking-[-0.05%] md:text-[64px]">
              Contact Us
            </h1>

            <p className="text-foreground/65 text-[18px] leading-[125%] tracking-[-0.05%] md:text-[20px]">
              At MonoHR, we&apos;re always here to help. Whether you have
              questions about hiring in India, compliance, or onboarding, our
              team is ready to assist you.
            </p>
            <div className="hidden px-4 pt-10 lg:block lg:px-0 lg:pt-12">
              <div className="space-y-8 text-[18px] leading-[160%] tracking-[-0.05%]">
                <div>
                  <p className="text-[#404040]">Phone:</p>
                  <a
                    href="tel:+919999561145"
                    className="mt-1 inline-block text-[#3649C7]"
                  >
                    +91 99995 61145
                  </a>
                </div>
                ...
                <div>
                  ...
                  <a
                    href="mailto:ashok@buildmonohr.com"
                    className="mt-1 inline-block text-[#2F47D2]"
                  >
          ...
          <div className="bg-[#FFFFFF] px-4 py-6 lg:p-8">
            <form className="space-y-4">
              <div>
                <label
                  htmlFor="fullName"
                  className="text-[20px] leading-5 text-[#1C1C1C]"
                >
                  Full Name
                </label>
                <input
        ...
        <div className="block px-4 pt-10 lg:hidden lg:px-0 lg:pt-12">
          <div className="space-y-8 text-[18px] leading-[160%] tracking-[-0.05%]">
            <div>
              <p className="text-[#404040]">Phone:</p>
              <a
