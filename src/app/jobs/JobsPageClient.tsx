    ...
    return (
        <section className="relative px-4 pb-16 lg:px-11.75 lg:pb-18.5">
            <div className="mx-auto w-full max-w-323 space-y-5">
                <h2 className="text-[24px] leading-[110%] tracking-[0.05%] font-[450] text-foreground">
                ...
                <div className="flex flex-col items-start justify-between gap-3 md:flex-row md:items-center">
                    <div className="flex h-8 w-full max-w-[500px] grow items-center gap-2 rounded-md border border-[#E2E8F0] bg-[#FFFFFF] px-3 py-2">
                        ...
                        <input
                            ...
                            className="m-0 h-fit w-full border-none bg-transparent p-0 text-sm text-content-loud placeholder:align-middle placeholder:text-[#6B7280] placeholder:leading-[100%] focus:outline-none"
                            placeholder="Search job"
                        />
                    </div>

                    <PillTab options={FILTER_OPTIONS} value={filter} onChange={handleFilterChange} />
                </div>
                ...
                <Pagination page={safePage} totalPages={totalPages} onPageChange={handlePageChange} className="pt-4" />
            </div>
        </section>
    )
}
